...
class FavoriteMealList extends StatefulWidget {
  FavoriteMealList({super.key});

  List<Meal> orderMeal = [];

  @override
  State<FavoriteMealList> createState() => _MealListState();
}

class _MealListState extends State<FavoriteMealList> {
  @override
  void initState() {
    super.initState();
  }
